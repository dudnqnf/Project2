...
<div id="myprofile" >
				...
				<tr>
					<td id="name" style="text-align: center; vertical-align:top; color: white; font-size: 20px;">
						...
						<span style="font-size:13px;">
							<fmt:formatDate value="${now}" pattern="yyyy" var="n" /> 
							<fmt:parseNumber var="b" type="number" value="${fn:substring(user_info.BIRTHDAY, 0, 4)}" />
							(<c:out value="${n-b+1}" />세)
						</span>
					</td>
				</tr>
	...
	<div class="div2">
		<div id="space1">
			<font size="2px">&nbsp;&nbsp;&nbsp;가입한 동호회</font></div>
		<div id="joined_clubs">
	...
	<div class="div3">
		<div id="space2">
			<font size="2px" style="text-align: bottom ">&nbsp;&nbsp;&nbsp;관심종목</font>
		</div>
