...
public final class SMSFactory {
	...
	private static Logger log = Logger.getLogger(SMSFactory.class);
	...
	public SMSFactory(String tempKey, String phone) throws Exception {
		...
		user_id = base64Encode("parkhs768");	//아이디
		secure = base64Encode("b844800aba673a5e219313d1c91a0e20 ");// 인증키
		...
		second_phone_number = base64Encode(nullcheck("6544", ""));
		third_phone_number = base64Encode(nullcheck("7330", ""));
