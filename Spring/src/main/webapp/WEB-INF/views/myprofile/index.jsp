...
<link href="<c:url value='/resources/css/myprofile.css?v=11'/>" rel="stylesheet">
...
<div id="photo_viewer">
	...
	<img id="photo_button_exit" onclick="history.back()" src="<c:url value="/resources/images/icon_X_white.png" />" />
...
<div class="header">
	...
	<div class="right_btn">
		<img src="../resources/images/icon_setting.png" onclick="location.replace('../myprofile/profile_setting.do?replace=myprofile')">
	</div>
</div>

<div id="myprofile" >
	<div class="div1">
		<img class="profile_background picture" src="../resources/upload/user/background/${user_info.PROFILE_BACKGROUND}" onerror="this.src='../resources/images/bg_img.jpg'">
		<div class="profile_background color" style="display:none;"></div>
		<c:if test="${user_info.SEX eq 0 && empty user_info.PROFILE_BACKGROUND}">
			<script>
				$(".profile_background.picture").css("display","none");
				$(".profile_background.color").css("display","").css("background-color","#85a7d1");
			</script>
		</c:if>
		<c:if test="${user_info.SEX eq 1 && empty user_info.PROFILE_BACKGROUND}">
			<script>
				$(".profile_background.picture").css("display","none");
				$(".profile_background.color").css("display","").css("background-color","#fab4b4");
			</script>
		</c:if>
			<table id="table_info">
				<tr>
					...
					<td id="section2">
						<image id="profile_img" src="../resources/upload/user/profile/${user_info.PROFILE}" onerror="this.src='../resources/images/icon_프로필사진(공백).png'">
					</td>
				...
				<tr>
					<td id="name" style="text-align: center; vertical-align:top; color: white; font-size: 20px;">
						${user_info.USER_NAME}&nbsp;<span class="user_age" style="font-size: 13px">(${user_info.AGE}세)</span>
					</td>
				</tr>
				<tr>
					<td id="location">
					...
					<td id="setting">
						<image id="icon_setting" src="../resources/images/내정보수정.png"
							onclick="location.replace('../myprofile/profile_modify.do?replace=myprofile')"></td>
					</td>
				</tr>
			</table>
	</div>
	...
	<div class="div2">
		...
		<div id="joined_clubs">
			<table style="width: 100%; background-color: white;">
				<c:forEach items="${user_fed}" var="list">
						<tr height="45px" onclick="location.href='../club/fed_detail.do?FED_CODE=${list.FED_CODE}'">
	...
	<div class="div3">
		<div id="space2">
			<font size="2px" style="text-align: bottom ">&nbsp;&nbsp;&nbsp;내 운동 경력과 운동실력을 추가 해보세요!</font>
		</div>
						...
						<td style="width:25%; text-align: right">
							<font size="2.5px">&nbsp;&nbsp;&nbsp;
								<c:choose>
									...
									<c:when test="${list.CAREER == 1}">1년 미만</c:when>
						...
						<td style="width:35%; text-align: center">
							<font size="2.5px">&nbsp;&nbsp;&nbsp;
								<c:if test='${list.NAME != "배드민턴"}'>
									<c:choose>
										<c:when test="${list.LEVEL == 11}"><span>선수 출신</span></c:when>
